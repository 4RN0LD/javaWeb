...
<html>
    ...
    <body>
        ...
        <div class="jumbotron">
            ...
            <hr class="my-4">
            <a href="Medico?accion=create" class="btn btn-outline-primary btn-lg my-4">Nuevo</a>
            <div class="table-responsive-sm">
                <table class="table table-striped bg-light">
                    ...
                    <tbody>
                        <c:forEach var="medico" items="${lst}">
                            <tr>
                                <td>${medico.nombre}</td>
                                <td>${medico.especialidad.especialidad}</td>
                                <td>
                                    <div class="btn-group" role="group">
                                        <a class="btn btn-outline-warning btn-sm" href="Medico?id=${medico.idMedico}&accion=GET">editar</a>
                                        <a class="btn btn-outline-danger btn-sm" href="Medico?id=${medico.idMedico}&accion=DEL">eliminar</a>
                                    </div>
                                </td>
                            </tr>
                        </c:forEach>
