...
<html>
    ...
    <body>
        ...
        <div class="jumbotron">
            ...
            <hr class="my-4">
            <a href="Paciente?accion=create" class="btn btn-outline-primary btn-lg my-4">Nuevo</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <a class="btn btn-outline-warning btn-sm" href="Paciente?id=${paciente.idPaciente}&accion=GET">editar</a>
                                        <a class="btn btn-outline-danger btn-sm" href="Paciente?id=${paciente.idPaciente}&accion=DEL">eliminar</a>
                                    </div>
                                </td>
                            </tr>
                        </c:forEach>
